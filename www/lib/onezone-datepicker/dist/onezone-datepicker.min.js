! function(e, t) {
        ...
        if (angular.isDefined(e) && angular.isArray(e) && e.length > 0)
            for (var a = 0; a < e.length; a++) {
                ...
                if (angular.isDefined(n.date) && u(t, n.date)) {
                    var i = "#F48685",
                        r = "#fff";
                    return angular.isDefined(n.color) && (i = n.color), angular.isDefined(n.textColor) && (r = n.textColor), { color: i, textColor: r } } }
        return null }

    function i(e, t, i, r, o, d, c, l, s) {
        var p = [];
        e = angular.copy(e);
        for (var g = 0; 7 > g; g++) { p.push({ fullDate: e, date: e.getDate(), month: e.getMonth(), year: e.getFullYear(), day: e.getDay(), isToday: u(e, new Date), isCurrentMonth: e.getMonth() === t.getMonth(), isDisabled: a(e, i, r, o, d, c, l), highlight: n(s, e) });
            var h = e;
    ...
    var r = {},
        ...
        u = function(t, a) {
            return e(t, a) },
        g = function(e) {
            for (var a = !1, n = 0, r = [], o = t(e.date, e.mondayFirst), d = o.getMonth(); !a;) { r.push({ days: i(o, e.date, e.disablePastDays, e.disableWeekend, e.disableDates, e.disableDaysOfWeek, e.displayFrom, e.displayTo, e.highlights) }), o.setDate(o.getDate() + 7);
    ...
    return r.getParameters = o, r.getYears = d, r.getActiveYearSlide = c, r.getMonths = l, r.getDaysOfTheWeek = s, r.getPreviousMonth = p, r.sameDate = u, r.createMonth = g, r.showTodayButton = h, r }), angular.module("onezone-datepicker", ["ionic", "onezone-datepicker.templates", "onezone-datepicker.service"]).directive("onezoneDatepicker", ["$ionicGesture", "onezoneDatepickerService", function(e, t) { "use strict";
    ...
    function a(e) {
        ...
        return a = angular.isDefined(e.datepickerObject) && angular.isDefined(e.datepickerObject.date) && angular.isDate(e.datepickerObject.date) ? angular.copy(e.datepickerObject.date) : angular.isDefined(e.datepickerObject) && angular.isDefined(e.datepickerObject.date) && angular.isNumber(e.datepickerObject.date) ? new Date(e.datepickerObject.date) : new Date, e.selectedDate = a, e.currentMonth = angular.copy(a), n = t.getParameters(e), e.createDatepicker = function(e) {
            var a = { date: e, mondayFirst: n.mondayFirst, disablePastDays: n.disablePastDays, displayFrom: n.displayFrom, displayTo: n.displayTo, disableWeekend: n.disableWeekend, disableDates: n.disableDates, disableDaysOfWeek: n.disableDaysOfWeek, highlights: n.highlights };
            return t.createMonth(a) }, e.month = e.createDatepicker(e.selectedDate), e.yearSlides = t.getYears(n.startYear, n.endYear), e.selectedYearSlide = t.getActiveYearSlide(e.yearSlides, e.currentMonth.getFullYear()), n }

    function n(e, t) { angular.isDefined(e.datepickerObject) && angular.isDefined(e.datepickerObject.showDatepicker) ? e.datepickerObject.showDatepicker = t : e.datepicker.showDatepicker = t }

    function i(e, t) { angular.isDefined(e.datepickerObject) && angular.isDefined(e.datepickerObject.date) && (e.datepickerObject.date = e.selectedDate), t.calendarMode || n(e, !1), angular.isDefined(t.callback) && t.callback(e.selectedDate) }
    var r = function(e, r, o) {
        var d = {};
        e.datepicker = { showDatepicker: !1, showLoader: !1, showMonthModal: !1, showYearModal: !1, showTodayButton: !1, calendarMode: !1, hideCancelButton: !1, hideSetButton: !1 }, d = a(e), e.datepicker.showDatepicker = d.showDatepicker || d.calendarMode, e.datepicker.calendarMode = d.calendarMode, e.datepicker.hideCancelButton = d.hideCancelButton, e.datepicker.hideSetButton = d.hideSetButton, e.datepicker.showTodayButton = t.showTodayButton(d), e.sameDate = function(e, a) {
            return t.sameDate(e, a) }, e.selectDate = function(a, n) { n || (e.selectedDate = a, e.month = e.createDatepicker(e.selectedDate), e.currentMonth = angular.copy(a), e.selectedYearSlide = t.getActiveYearSlide(e.yearSlides, e.currentMonth.getFullYear()), (d.calendarMode || d.hideSetButton) && i(e, d)) }, e.selectToday = function() {
            var a = new Date;
            e.selectedDate = a, e.month = e.createDatepicker(e.selectedDate), e.currentMonth = angular.copy(a), e.selectedYearSlide = t.getActiveYearSlide(e.yearSlides, e.currentMonth.getFullYear()), (d.calendarMode || d.hideSetButton) && i(e, d) }, e.selectMonth = function(t) { e.currentMonth = new Date(e.currentMonth.getFullYear(), t, 1), e.month = e.createDatepicker(e.currentMonth), e.closeModals() }, e.selectYear = function(a) { e.currentMonth = new Date(a, e.currentMonth.getMonth(), 1), e.selectedYearSlide = t.getActiveYearSlide(e.yearSlides, e.currentMonth.getFullYear()), e.closeYearModal() }, e.nextMonth = function() { e.currentMonth = new Date(e.currentMonth.getFullYear(), e.currentMonth.getMonth() + 1, 1), e.selectedYearSlide = t.getActiveYearSlide(e.yearSlides, e.currentMonth.getFullYear()), e.month = e.createDatepicker(e.currentMonth) }, e.previousMonth = function() { e.currentMonth = t.getPreviousMonth(e.currentMonth), e.selectedYearSlide = t.getActiveYearSlide(e.yearSlides, e.currentMonth.getFullYear()), e.month = e.createDatepicker(e.currentMonth) }, e.swipeLeft = function() { d.disableSwipe || e.nextMonth() }, e.swipeRight = function() { d.disableSwipe || e.previousMonth() }, e.closeModals = function() { e.datepicker.showMonthModal = !1, e.datepicker.showYearModal = !1 }, e.openMonthModal = function() { e.datepicker.showMonthModal = !0 }, e.openYearModal = function() { e.datepicker.showMonthModal = !1, e.datepicker.showYearModal = !0 }, e.closeYearModal = function() { e.datepicker.showYearModal = !1, e.datepicker.showMonthModal = !0 }, e.showDatepicker = function() { e.datepicker.showDatepicker || n(e, !0) }, e.hideDatepicker = function() { n(e, !1) }, e.setDate = function() { i(e, d) }, e.$watch("datepickerObject.date", function(a) { angular.isNumber(a) && (a = new Date(a)), t.sameDate(a, e.selectedDate) || (e.selectedDate = a, e.month = e.createDatepicker(e.selectedDate), e.currentMonth = angular.copy(a), e.selectedYearSlide = t.getActiveYearSlide(e.yearSlides, e.currentMonth.getFullYear())) }), e.$watch("datepickerObject.showDatepicker", function(t) { e.datepicker.showDatepicker = t }), e.$watchCollection("datepickerObject.highlights", function() { a(e) }), e.$watchCollection("datepickerObject.disableDates", function() { a(e) }), r.on("click", function(t) {
            var n = t.target;
            angular.isDefined(n) && angular.element(n).hasClass("show-onezone-datepicker") && e.$apply(function() { a(e), e.showDatepicker() }) }) };
    return { restrict: "AE", replace: !0, transclude: !0, link: r, scope: { datepickerObject: "=datepickerObject" }, templateUrl: "onezone-datepicker.html" } }]);
